...
void drawDialogueChoices(char* dialogue, char* choice1, char* choice2) {
    fillScreen(BLACK);
    setTextSize(1);
    setTextColor(WHITE, BLACK);
    int border_y = 70;
    int border_x = 6;
    setCursor(border_x,border_y);
    Outstr(dialogue);

    setCursor(border_x - 3,border_y + 9);
    Outstr("SW3");
    setCursor(border_x - 3, border_y + 18);
    Outstr("SW2");

    setCursor(border_x + 18,border_y + 9);
    Outstr(choice1);
    setCursor(border_x + 18, border_y + 18);
    Outstr(choice2);
}
...
void horizontallines(void){
    fillScreen(BLACK);

    int y = 0;
    while(y < 4){
        drawLine(0,0+y,128,0+y,RED);
        drawLine(0,16+y,128,16+y,BLUE);
        drawLine(0,32+y,128,32+y,CYAN);
        drawLine(0,48+y,128,48+y,GREEN);
        drawLine(0,64+y,128,64+y,YELLOW);
        drawLine(0,80+y,128,80+y,0xF855);
        drawLine(0,96+y,128,96+y,WHITE);
        drawLine(0,112+y,128,112+y,MAGENTA);
        y++;
    }
}
...
void verticallines(void){
    ...
    int y = 0;
    while(y < 4){
        drawLine(0+y,128,0+y,0,RED);
        drawLine(16+y,128,16+y,0,BLUE);
        drawLine(32+y,128,32+y,0,CYAN);
        drawLine(48+y,128,48+y,0,GREEN);
        drawLine(64+y,128,64+y,0,YELLOW);
        drawLine(80+y,128,80+y,0,0xF855);
        drawLine(96+y,128,96+y,0,WHITE);
        drawLine(112+y,128,112+y,0,MAGENTA);
        y++;
    }
}
