...
*/
    ...
    // Set DC Pin LOW to command mode
    GPIOPinWrite(GPIOA3_BASE, DC_PIN, false);
    GPIOPinWrite(GPIOA3_BASE, OLEDCS_PIN, false);

    MAP_SPIDataPut(GSPI_BASE, c);
    MAP_SPIDataGet(GSPI_BASE, &e);

    GPIOPinWrite(GPIOA3_BASE, OLEDCS_PIN, OLEDCS_PIN);
...
*/
    unsigned long e;
    MAP_SPICSEnable(GSPI_BASE);
    // Set DC Pin HIGH to data mode
    GPIOPinWrite(GPIOA3_BASE, OLEDCS_PIN, false);
    GPIOPinWrite(GPIOA3_BASE, DC_PIN, DC_PIN);
